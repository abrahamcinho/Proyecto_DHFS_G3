CREATE TABLE `sweetdreams`.`users` ( `user_id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT , `first_name` VARCHAR(100) NOT NULL , `last_name` VARCHAR(100) NOT NULL , `email` VARCHAR(100) NOT NULL , `password` VARCHAR(250) NOT NULL , `avatar` VARCHAR(255) NOT NULL , `user_categ_id` INT(10) UNSIGNED NOT NULL , PRIMARY KEY (`user_id`)) ENGINE = InnoDB; 
...
ALTER TABLE `sweetdreams`.`users` DROP INDEX `user_categ_id`, ADD INDEX `users_user_categ_id_fk` (`user_categ_id`) USING BTREE; 
...
ALTER TABLE `products` ADD INDEX(`flavor_id`);
...
ALTER TABLE `sweetdreams`.`sizes_products` DROP INDEX `size_id`, ADD INDEX `sizes_products_size_id` (`size_id`) USING BTREE; 
